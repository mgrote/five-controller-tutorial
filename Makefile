...
IMG ?= mgrotedev/personal-iot:v1alpha1
# ENVTEST_K8S_VERSION refers to the version of kubebuilder assets to be downloaded by envtest binary.
ENVTEST_K8S_VERSION = 1.25.0

include config/manager/mqtt.env
export
...
.PHONY: run-delve
run-delve: manifests generate fmt vet ## Run a controller from your host with delve.
